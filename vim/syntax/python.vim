" This Python syntax was modified so that it better matches MagicPython
" syntax highlighter.
...
" =============
    ...
    hi def link  pythonLambdaExpr   Define
    ...
    hi def link  pythonExtraOperator        Special
    hi def link  pythonExtraPseudoOperator  Special

    hi def link  pythonDecorator    Define
    hi def link  pythonDottedName   Function
    hi def link  pythonDot          Special
