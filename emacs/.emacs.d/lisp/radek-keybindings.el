(use-package key-chord
  ...
  (define-key                           ; Yafolding
    yafolding-mode-map (kbd "<C-S-return>") nil)
  (define-key
    yafolding-mode-map (kbd "<C-M-return>") nil)
  (define-key
    yafolding-mode-map (kbd "<C-return>") nil)
  (define-key
    yafolding-mode-map (kbd "<C-M-return>") 'yafolding-toggle-all)
  (define-key
    yafolding-mode-map (kbd "<C-return>") 'yafolding-toggle-element)
